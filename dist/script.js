...
window.addEventListener('DOMContentLoaded', function () {
  ...
  new _modules_form__WEBPACK_IMPORTED_MODULE_4__["default"](".form__block").init();
});
...
function () {
  ...
  _createClass(Difference, [{
    key: "bindTriggers",
    value: function bindTriggers(btn, items, counter) {
    ...
    value: function init() {
      ...
      this.forms.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          ...
          statusMessage.textCoontent = _this.message.loading;
          var formData = new FormData(item);

          _this.postData(_this.path, formData).then(function (res) {
            console.log(res);
            statusMessage.textCoontent = _this.message.success;
          }).catch(function () {
            statusMessage.textCoontent = _this.message.failure;
          }).finally();
        });
      });
    }
